...
border_color = dbc.Card([
    ...
    html.Div(
        [
            ...
            html.P("border border-secondary ", className="border border-secondary "),
...
border_rounded = dbc.Card([
    ...
    html.Div(
        [
            ...
            html.P("border rounded-circle ", className="border rounded-circle d-flex align-items-center justify-content-center", style={"height":200,"width":200}),
            html.P("border rounded-pill ", className="border rounded-pill ", style={"width":200}),
        ], className="p-4"
    )
], className="m-4")
...
app.layout = html.Div([title, border_direction,
                       border_direction_0, border_color, border_size, border_rounded,
                       ])

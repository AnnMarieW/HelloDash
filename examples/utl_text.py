...
text_wrap = dbc.Card(
    [
        ...
        html.P(dbc.Badge("text-wrap will wrap text onto the next line", className="text-wrap", style={"width": 100})),
        html.P(dbc.Badge("text-nowrap won't wrap text", className="text-nowrap", style={"width": 100})),
        html.P(
            html.P(
...
font_monospace = html.P("font-monospace  This is in monospace", className="font-monospace")
...
app.layout = html.Div([title, text_wrap, text_option, fs_size, fw_weight, fst_style, lh_style, text_decoration])

...
figure_sampler_code_card = util.make_code_card(figure_sampler_code, id="figure_sampler_code", height=450)


four_figures_code = util.get_code_file("demo_4_graphs.py")
four_figures_code_card = util.make_code_card(four_figures_code, id="four_figures_code", height=450)

...
buttons1 = dbc.Col(
    [
        ...
        html.Div(
            [
                dbc.Button(
                    "Primary", outline=True, color="primary", className="me-1 mt-1",
                ),
                dbc.Button(
                    "Secondary", outline=True, color="secondary", className="me-1 mt-1",
                ),
                dbc.Button(
                    "Success", outline=True, color="success", className="me-1 mt-1",
                ),
                dbc.Button(
                    "Warning", outline=True, color="warning", className="me-1 mt-1",
                ),
                dbc.Button(
                    "Danger", outline=True, color="danger", className="me-1 mt-1",
                ),
        ...
        html.Div(
            [
                ...
                dbc.Button(
                    "Active", color="primary", active=True, className="me-1 mt-1",
                ),
                dbc.Button(
                    "Disabled", color="primary", disabled=True, className="me-1 mt-1",
                ),
            ],
            className="mb-2",
        ),
